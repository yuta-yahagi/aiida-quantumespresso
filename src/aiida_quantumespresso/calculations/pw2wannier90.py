...
from aiida.orm import Dict, FolderData, RemoteData, SinglefileData, Str
...
class Pw2wannier90Calculation(NamelistsCalculation):
    ...
    def define(cls, spec):
        ...
        spec.input('seedname', valid_type=Str,
                   help='The seedname of the Wannier90 calculation',
                   requred=False)
    ...
    def prepare_for_submission(self, folder):
        ...
        # If seedname is given, use it, otherwise use 'aiida'
        if getattr(self.inputs, 'seedname', False):
            seedname=self.inputs.seedname.value
        else:
            seedname=self._SEEDNAME
        calcinfo.local_copy_list.append((nnkp_file.uuid, nnkp_file.filename, f'{seedname}.nnkp'))
